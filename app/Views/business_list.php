...
$sessionRegionName    = $session->get("region");
$sessionCityName      = $session->get("city");
$sessionCategoryName  = $session->get("category");
...
<div class="main-container zone_list">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-xs-12 breadcrumb-sa">
        <?php echo $session->get("breadcrumb"); ?>
      </div>
    </div>
    <div class="row">
        ...
        <aside>
                ...
                <div class="form-group" style="padding: 5px;">
                  ...
                  <select class="form-control" id="exampleFormControlSelect1">
                    <?php foreach($regions as $region): ?>
                      <?php
                      $selected ="";
                      if($session->get("region") == $region['name_short']){
                        $selected ="selected";
                      }
                      ?>
                      <option value="<?= $region['name_short'] ?>" <?= $selected ?>><?= $region['name'] ?></option>
                    <?php endforeach; ?>
                  </select>
          ...
          <div class="widget categories">
            ...
            <ul class="categories-list">
              <?php if($cityListByRegion): ?>
              <?php foreach($cityListByRegion as $city): ?>
                <li>
                  <a href="<?= site_url() ?>searchEngine?q=&region=<?= $sessionRegionName ?>&city=<?= $city->name_short ?>&category=<?= $sessionCategoryName ?>">
                    <i class="lni-dinner"></i>
                    <?php echo $city->name; ?> <span class="category-counter">(<?= $city->total ?>)</span>
                  </a>
                </li>
              <?php endforeach; ?>
              <?php endif; ?>
          ...
          <?php if($categoryListByRegion): ?>
          <div class="widget categories">
            <h4 class="widget-title">Categorías</h4>
            <ul class="categories-list">
              <?php if($categoryListByRegion): ?>
              <?php foreach($categoryListByRegion as $category): ?>
                <li>
                  <!--<a href="<?= site_url() ?>category/<?= $category->name_short; ?>">-->
                  <a href="<?= site_url() ?>searchEngine?q=&region=<?= $sessionRegionName ?>&city=<?= $sessionCityName ?>&category=<?= $category->name_short ?>">
                    <i class="lni-dinner"></i>
                    <?php echo $category->name; ?> <span class="category-counter">(<?= $category->total ?>)</span>
                  </a>
                </li>
              <?php endforeach; ?>
              <?php endif; ?>
      ...
      <div class="col-lg-9 col-md-12 col-xs-12 page-content">
        ...
        <div class="product-filter">
          <div class="short-name">
            <span>
              Se encontraron <?= count($business); ?> producto (s)
            </span>
          </div>
                    ...
                    <div class="featured-box">
                      <figure>
                        ...
                        <a href="<?= site_url() ?>business/<?php echo $deal->business_nameshort; ?>">
                          <img class="img-fluid" src="<?= base_url().'/business/'.$deal->id.'/'.$deal->id.'.png' ?>" alt="">
                        </a>
                      </figure>
                      <div class="feature-content">
                        <div class="product">
                          <a href="<?= site_url() ?>category/<?= $deal->category_name_short; ?>"><?php echo $deal->category_name; ?></a>
                        </div>
                        <h4>
                          <a href="<?= site_url() ?>business/<?php echo $deal->business_nameshort; ?>"><?php echo $deal->name; ?></a>
                        </h4>
                        <div class="meta-tag">
                          <div class="row">
                            <div class="col-lg-12">
                              <span>
                                ...
                                <a href="<?= site_url() ?>city/<?php echo $deal->region_name_short; ?>/<?php echo $deal->city_name_short; ?>"><?php echo $deal->city_name; ?></a>,
                                <a href="<?= site_url() ?>region/<?php echo $deal->region_name_short; ?>"><?php echo $deal->region_name; ?></a>
                              </span>
                            </div>
                            <div class="col-lg-12">
                              <span>
